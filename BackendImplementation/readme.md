...
## Introduction
The backend of the project (implement in C#) contains of a Web Api, which provides methods for registering a new user, login of existing useres, and up- and downloading files.
